...
public class Main {
    public static void main(String[] args) {
        ...
        fractionOperationResult = fraction1.sub(fraction2);
        System.out.printf("(%s) - (%s) = (%s)\n", fraction1, fraction2, fractionOperationResult);
        fractionOperationResult = fraction1.mul(fraction2);
        System.out.printf("(%s) * (%s) = (%s)\n", fraction1, fraction2, fractionOperationResult);
        fractionOperationResult = fraction1.div(fraction2);
        System.out.printf("(%s) - (%s) = (%s)\n", fraction1, fraction2, fractionOperationResult);
        fractionComparingResult = fraction1.isEqual(fraction2);
        ...
        moneyOperationResult = money1.sub(money2);
        System.out.printf("%s - %s = %s\n", money1, money2, moneyOperationResult);
        moneyOperationResult = money1.div(money2);
        System.out.printf("%s / %s = %s\n", money1, money2, moneyOperationResult);
        moneyOperationResult = money1.mul(money2);
        System.out.printf("%s * %s = %s\n", money1, money2, moneyOperationResult);
        moneyOperationResult = money1.divToDouble(doubleNumber);
        System.out.printf("%s / %s = %s\n", money1, doubleNumber, moneyOperationResult);
        moneyOperationResult = money1.mulToDouble(doubleNumber);
        System.out.printf("%s * %s = %s\n", money1, doubleNumber, moneyOperationResult);
        moneyComparingResult = money1.isEqual(money2);
